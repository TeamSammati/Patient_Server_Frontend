      ...
      <div className="footer-container">
            <div className="footer-row">
                <div className="footer-col">
                    ...
                    <h4>Get Help</h4>
                    <ul>
                        <li><a href="/" target="_blank">Ministry of Health Care</a></li>
                        <li><a href="/" target="_blank">Help Team</a></li>
                        <li><a href="/" target="_blank">Grievance Cell</a></li>
                    ...
                    <ul>
                        <li><a href="/" target="_blank">Natioanl Health Reports</a></li>
                        <li><a href="/" target="_blank">Covid Care</a></li>
                        <li><a href="/" target="_blank">NIMHANS</a></li>
                    </ul>
                    </div>
                    <div className="footer-col">
                    <h4>Follow Us</h4>
                    <div className="social-links">
                      <a href="/" target="_blank">Facebook &nbsp;&nbsp; Twitter &nbsp;&nbsp; Youtube</a>
                    </div>
                </div>
            </div>
        </div>
